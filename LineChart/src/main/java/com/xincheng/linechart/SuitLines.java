...
package com.xincheng.linechart;
...
/**
 *  开源控件地址:https://github.com/whataa/SuitLines
 *  TODO 宽度高度测量那里不够灵活，只能写死才能用。
 */
public class SuitLines extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        /*widthSize = widthSize == 0 ? MeasureSpec.getSize(widthMeasureSpec) : widthSize;      //取出宽度的确切数值
        heightSize = heightSize == 0 ? MeasureSpec.getSize(heightMeasureSpec) : heightSize;    //取出高度的确切数值
        Log.e("data","width:"+widthSize+",height:"+heightSize);
    ...
    private void calcAreas() {
        ...
        //是否显示x轴、y轴
        linesArea = new RectF(isShowX ? yArea.right+1 : basePadding, yArea.top, xArea.right, isShowX ? yArea.bottom : yArea.bottom + xArea.height());
...
//    }
    ...
    public void showX(boolean isShowX){
        this.isShowX = isShowX;
        postInvalidate();
    }


    public void showY(boolean isShowY){
