...
public class SP {
        ...
        private static SP util;
        private static SharedPreferences sp;

        private SP(Context context, String name) {
     ...
     * @return 保存结果
     */
    public static <T> boolean putSetData(String key, Set<T> set) {
        boolean result;
        String type = null;
        for (T t: set) {
        ...
        try {
            switch (type) {
                ...
                default:
                    Gson gson = new Gson();
                    for (T t : set) {
                        JsonElement obj = gson.toJsonTree(t);
                        array.add(obj);
                    }
                    break;
            }
     ...
     * @return 对应的Set集合
     */
    public static <T> Set<T> getSetData(String key, Class<T> cls) {
