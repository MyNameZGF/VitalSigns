 ...
 * 大便
 */
public class ExcrementFragment extends BaseFragment {
    ...
    public static BaseFragment newInstance(int type) {
        ...
        ExcrementFragment fragment = new ExcrementFragment();
    ...
    protected void initView() {
        ...
        tv_title.setText(getString(R.string.dayOf7Excrements));
    }
    ...
    private List<TempDetailsBean> getDatas() {
        ...
        for(int i = 0;i<32;i++){
            bean = new TempDetailsBean(DateUtils.long2String(System.currentTimeMillis()),i % 3+1,"李宏"+i,i % 3,i,fragmentFlag);
            data.add(bean);
        }
        return data;
    }
