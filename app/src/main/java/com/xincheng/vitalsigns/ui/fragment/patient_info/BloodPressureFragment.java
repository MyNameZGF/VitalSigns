...
public class BloodPressureFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        tv_title.setText(getString(R.string.dayOf7BloodPressure));
    }
    ...
    private List<TempDetailsBean> getDatas() {
        ...
        for(int i = 0;i<32;i++){
            bean = new TempDetailsBean(DateUtils.long2String(System.currentTimeMillis()),110+i,"李宏"+i,i % 3,i,fragmentFlag);
            data.add(bean);
        }
        return data;
    }
