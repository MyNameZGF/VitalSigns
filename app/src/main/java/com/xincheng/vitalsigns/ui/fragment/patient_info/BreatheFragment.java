 ...
 * 呼吸
 */
public class BreatheFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        tv_title.setText(getString(R.string.dayOf7Breathes));
    }
    ...
    private List<TempDetailsBean> getDatas() {
        ...
        for(int i = 0;i<45;i++){
            bean = new TempDetailsBean(DateUtils.long2String(System.currentTimeMillis()),30-i,"李宏"+i,i % 3,i,fragmentFlag);
            data.add(bean);
        }
        return data;
    }
