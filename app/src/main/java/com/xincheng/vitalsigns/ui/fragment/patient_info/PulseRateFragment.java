...
public class PulseRateFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        tv_title.setText(getString(R.string.dayOf7PulseRate));
    }
    ...
    private List<TempDetailsBean> getDatas() {
        ...
        for(int i = 0;i<32;i++){
            bean = new TempDetailsBean(DateUtils.long2String(System.currentTimeMillis()),80+i,"李宏"+i,i % 3,i,fragmentFlag);
            data.add(bean);
        }
        return data;
    }
